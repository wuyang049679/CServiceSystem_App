...
public class ImagePreviewActivity extends AppCompatActivity implements Handler.Callback, View.OnClickListener {
    ...
    private static String IMG_TRANSITIONS="img_transitions";
    ...
    public static void activityStart(Context context, ImageView imageView, boolean isGifs) {
        if (context == null) {
            return;
        }
        isGif=isGifs;
        if (Build.VERSION.SDK_INT < 21) {
            ...
            ActivityOptionsCompat options = ActivityOptionsCompat.
                    makeSceneTransitionAnimation((Activity) context, imageView, IMG_TRANSITIONS);
    ...
    private void initTransition() {
        if ( Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if (!isGif) {
            ViewCompat.setTransitionName(viewPager, IMG_TRANSITIONS);
            }
