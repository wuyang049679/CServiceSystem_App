...
public class ImagePreview {
    ...
    public ImagePreview setContext(@NonNull Context context, ImageView img) {
    ...
    public void start() {
        ...
        ImagePreviewActivity.activityStart(context,imageView,isGif);
    }

    public ImagePreview isGif(String picUrl) {
