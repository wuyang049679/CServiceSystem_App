...
//        ll_list.setPadding(60, 70, 80, 70);
        ...
        for (int i = 0; i < operationList.size(); i++) {
            ...
            if (i != operationList.size() - 1) {
                ...
                LinearLayout.LayoutParams mlp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 1);
...
//        setArrow(down, (int) (centerArrowX - getX()));
    ...
    public void setGone() {
        ll_list.getChildAt(3).setVisibility(GONE);
        ll_list.getChildAt(4).setVisibility(GONE);
    }
    public void setVisibilitys() {
        ll_list.getChildAt(3).setVisibility(VISIBLE);
        ll_list.getChildAt(4).setVisibility(VISIBLE);
    }
}
