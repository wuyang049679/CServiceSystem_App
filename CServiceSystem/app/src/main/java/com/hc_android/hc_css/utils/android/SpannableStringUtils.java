...
//        RectF rect = new RectF(x, top, x + measureText(paint, text, start, end), bottom);
            ...
            float tops = fontMetrics.top;//为基线到字体上边框的距离,即上图中的top
            float bottoms = fontMetrics.bottom;//为基线到字体下边框的距离,即上图中的bottom

            int baseLineY = (int) (rect.centerY() - tops/2 - bottoms/2);//基线中间点的y轴计算公式
...
//            paint.setTextAlign(Paint.Align.CENTER);
            ...
            canvas.drawText(text, start, end,rect.centerX(),baseLineY, textPaint);
