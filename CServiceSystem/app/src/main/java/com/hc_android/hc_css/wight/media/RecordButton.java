package com.hc_android.hc_css.wight.media;
...
public class RecordButton extends AppCompatButton {
    ...
    private void init() {
        ...
        this.setTextSize(14);
        this.setTextColor(getResources().getColor(R.color.black_333));
    }
...
//                    LogUtil.d("结束录音:");
    ...
    private void initDialogAndStartRecord() {
        ...
        boolean flag = EasyPermissionUtils.checkPermission((Activity) getContext(), perms);
        if (!flag) {
            EasyPermissionUtils.requireSomePermission((Activity) getContext(),"获取手机录音，读写权限",1,perms);
        } else {
...
//            LogUtil.d("获取到的时长:"+mediaPlayer.getDuration()/1000);
        ...
        if (finishedListener != null)
            isTimeOut=false;
            finishedListener.onFinishedRecord(mFile,(float) mediaPlayer.getDuration()/1000);
...
//                LogUtil.d("检测到的分贝002:"+mRecorder);
                ...
                volumeHandler.sendEmptyMessage(-1);
                if(System.currentTimeMillis() - startTime > 59700){
