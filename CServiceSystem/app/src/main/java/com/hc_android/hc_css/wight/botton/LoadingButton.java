package com.hc_android.hc_css.wight.botton;
...
public class LoadingButton extends DrawableTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLoadingDrawable.setStrokeWidth(loadingDrawableSize * 0.07f);
...
//            if (TextUtils.isEmpty(getText())) {
              ...
              setCompoundDrawablesRelative(mLoadingDrawable, null, null, null);
              setEnableTextInCenter(false);
              setBackground(getResources().getDrawable(R.drawable.login_btn_f));
//            }
            startLoading();
        }
    }
    ...
    private void end(boolean isFail) {
        setBackground(getResources().getDrawable(R.drawable.login_btn));
        if (mEndDrawable != null) {
            if (mShrinkAnimator.isRunning())
                mShrinkAnimator.end();
